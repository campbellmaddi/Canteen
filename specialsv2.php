        ...
        if (isset($_POST['Monday'])) {
            if (mysqli_num_rows($result_monday) != 0) {
                while ($test = mysqli_fetch_array($result_monday)) {
                    ...
                    echo "<td>" . $test['FoodID'] . "</td>";
                    echo "<td>" . $test['DrinkID'] . "</td>";
